 ...
 *
 * @author mohamed antar
 * @copyright Copyright © 2010-2012 mohamed antar, All rights reserved.
 */
...
tinymce.create('tinymce.plugins.icodePlugin', {
		...
		getInfo : function() {
			return {
				...
				author : 'mohamed antar',
				authorurl : 'www.3ntar.net',
				infourl : 'http://www.3ntar.net/articles/e4c4dbac-619e-4965-aef4-6e0019650f5f.aspx',
				version : "1.0"
			};
		}
	});
